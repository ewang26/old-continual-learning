...
#         use_wandb=True,
#     ):
#         super().__init__(memory_set_manager, dataset_path, use_wandb=use_wandb)
#         self.model = MLP(**MNLIST_MLP_ARCH)


#     def compute_metric(self, model: Type[nn.Module], x: np.ndarray, y: np.ndarray):
